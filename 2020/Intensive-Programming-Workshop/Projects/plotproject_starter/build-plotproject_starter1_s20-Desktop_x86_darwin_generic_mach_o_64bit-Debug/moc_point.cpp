...
#include "../plotproject_starter/point.h"
...
QT_MOC_LITERAL(6, 42, 10) // "createLine"
...
void Point::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->createLine((*reinterpret_cast< Point*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Point::*)(Point * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Point::createLine)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Point::createLine(Point * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
